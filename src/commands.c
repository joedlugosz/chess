...
void ui_fen(engine_s *e) {
  char placement[100]; get_input_to_buf(placement, sizeof(placement));
  char active[100]; get_input_to_buf(active, sizeof(active));
  char castling[100]; get_input_to_buf(castling, sizeof(castling));
  char enpassant[100]; get_input_to_buf(enpassant, sizeof(enpassant));
